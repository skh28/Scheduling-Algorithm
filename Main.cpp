...
string Files[] = {"C:\\Users\\Scott\\Desktop\\testdata1.txt", "C:\\Users\\Scott\\Desktop\\testdata2.txt", "C:\\Users\\Scott\\Desktop\\testdata3.txt", "C:\\Users\\Scott\\Desktop\\testdata4.txt"};
...
rawname = "C:\\Users\\Scott\\Desktop\\FirstComeFirstServe" + rawname + ".txt";
...
rawname = "C:\\Users\\Scott\\Desktop\\ShortestJobFirst" + rawname + ".txt";
csv.open(rawname.c_str());
...
rawname = "C:\\Users\\Scott\\Desktop\\RoundRobbin" + s + "quanta" + rawname + ".txt";
csv.open(rawname.c_str());
//takes pid and burst time from file and creating tuple objects then storing them into a vector of tuples
while(input >> pid >> burstTime >> temp)
    {
...
rawname = "C:\\Users\\Scott\\Desktop\\Lottery" + rawname + ".txt";
csv.open(rawname.c_str());
//takes pid and burst time from file and creating tuple objects then storing them into a vector of tuples
